...
\author{
\IEEEauthorblockN{W. Lewis Collier, Ph.D.}
\IEEEauthorblockA{LCollier@umd.edu}
%\and
...
\subsection{Units}
This section gives an example of how to do bullet lists.
See {\url https://tex.stackexchange.com/} for answers to most any \LaTeX questions you may have.
...
Examples include Acknowledgments and References and, for these, the correct style to use is ``Heading 5''. 
Use ``figure caption'' for your Figure captions, and ``table head'' for your table title. 
...
For example, the paper title is the primary text head because all subsequent material relates and elaborates on this one topic. 
If there are two or more sub-topics, the next level head (uppercase Roman numerals) should be used and, conversely, if there are not at least two sub-topics, then no subheads should be introduced.
...
\begin{LaTeXdescription}%see https://ras.papercept.net/conferences/support/files/IEEEtran_HOWTO.pdf to get traidtional LaTeX list environments
